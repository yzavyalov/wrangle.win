...
Route::get('/bets/{paginate}', [BetController::class,'index']);
Route::get('/bets/{id}', [BetController::class,'show']);
Route::post('/search-bet/{paginate}',[BetSortController::class,'searchBet']);
Route::get('/finish-bets/{paginate}',[BetSortController::class,'finishBet']);
Route::get('/hot-bets/{paginate}',[BetSortController::class,'hotBets']);

Route::get('/bet-categories/{paginate}', [BetCategoryController::class,'index']);
Route::get('/bet-categories/{id}', [BetCategoryController::class,'show']);
Route::post('/search-category/{paginate}',[BetCategorySearchController::class,'searchCategory']);
...
Route::middleware(['auth:sanctum','baduser'])->group(function (){
    ...
    Route::get('/own-bets/{paginate}',[BetSortController::class,'myBets']);
    Route::get('/favorite-bets/{paginate}',[BetSortController::class,'favoriteBets']);
