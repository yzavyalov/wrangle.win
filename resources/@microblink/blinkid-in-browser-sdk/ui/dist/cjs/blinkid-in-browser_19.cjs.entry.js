...
const index = require('./index-c53fb7ff.js');
...
const BlinkidInBrowser = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("mb-container", null, index.h("mb-component", { dir: this.hostEl.getAttribute("dir"), ref: (el) => (this.mbComponentEl = el), allowHelloMessage: this.allowHelloMessage, recognitionPauseTimeout: this.recognitionPauseTimeout, cameraExperienceStateDurations: this.cameraExperienceStateDurations, engineLocation: this.engineLocation, workerLocation: this.workerLocation, licenseKey: this.licenseKey, wasmType: this.wasmType, blinkIdVariant: this.blinkIdVariant, recognizers: this.finalRecognizers, recognizerOptions: this.recognizerOptions, recognitionTimeout: this.recognitionTimeout, enableDrag: this.enableDrag, hideLoadingAndErrorUi: this.hideLoadingAndErrorUi, scanFromCamera: this.scanFromCamera, scanFromImage: this.scanFromImage, thoroughScanFromImage: this.thoroughScanFromImage, galleryOverlayType: this.galleryOverlayType, galleryDropType: this.galleryDropType, showActionLabels: this.showActionLabels, showModalWindows: this.showModalWindows, showCameraFeedbackBarcodeMessage: this.showCameraFeedbackBarcodeMessage, iconCameraDefault: this.iconCameraDefault, iconCameraActive: this.iconCameraActive, iconGalleryDefault: this.iconGalleryDefault, iconGalleryActive: this.iconGalleryActive, iconInvalidFormat: this.iconInvalidFormat, iconSpinnerScreenLoading: this.iconSpinnerScreenLoading, iconSpinnerFromGalleryExperience: this.iconSpinnerFromGalleryExperience, iconGalleryScanningCompleted: this.iconGalleryScanningCompleted, sdkService: this.sdkService, translationService: this.translationService, cameraId: this.cameraId, allowHelpScreens: true, pingProxyUrl: this.pingProxyUrl, allowHelpScreensFab: this.allowHelpScreensFab, allowHelpScreensOnboarding: this.allowHelpScreensOnboarding, allowHelpScreensOnboardingPerpetuity: this.allowHelpScreensOnboardingPerpetuity, helpScreensTooltipPauseTimeout: this.helpScreensTooltipPauseTimeout, onBlock: (ev) => {
      ...
      }, onFeedback: (ev) => this.feedbackEl.show(ev.detail) }), index.h("mb-feedback", { dir: this.hostEl.getAttribute("dir"), visible: !this.hideFeedback, ref: (el) => (this.feedbackEl = el) }))));
  }
...
const MbButtonClassic = class {
  ...
  render() {
    return (index.h(index.Host, { class: classNames({
      ...
      }) }, index.h("button", { part: "button", disabled: this.disabled, onClick: this.clickHandler }, index.h("slot", null))));
  }
  get hostEl() { return index.getElement(this); }
};
...
const MbHelp = class {
  ...
  render() {
    return (index.h(index.Host, { class: classNames({ visible: this.amIVisible() }) }, this.amIVisible(this.allowFab) && (index.h("div", { class: "lobby" }, index.h("button", { onClick: () => {
        this.openInternal();
      }, onMouseEnter: () => {
        this.isTooltipShownHover = true;
      }, onMouseLeave: () => {
        this.isTooltipShownHover = false;
      } }, index.h(SvgQuestionMark, null)), index.h("mb-tooltip-advanced", { show: this.isTooltipShownHover || this.isTooltipShownTimer, arrowPosition: "arrow-down-right", message: this.texts.tooltip }))), index.h("mb-overlay", { visible: this.amIVisible(this.isModalShown) }, index.h("mb-modal", { visible: this.amIVisible(this.isModalShown), centered: true, elevated: true, hideFooter: true, hideCloseButton: this.activeStepIndex === 0, onClose: (event) => {
        event.stopPropagation();
        this.closeInternal();
      } }, index.h("div", { class: "modal-content", slot: "content" }, index.h("div", { class: "svg-container" }, this.activeStepIndex === 0 && index.h(SvgValidDocument, null), this.activeStepIndex === 1 && (index.h(SvgInvalidDocumentInvisibleFields, null)), this.activeStepIndex === 2 && index.h(SvgInvalidDocumentHarshLight, null), this.activeStepIndex === 3 && (index.h(SvgInvalidDocumentToMuchMotion, null))), index.h("p", { class: "title" }, this.texts.steps[this.activeStepIndex].title), index.h("p", { class: "description" }, this.texts.steps[this.activeStepIndex].description), this.activeStepIndex > 0 && (index.h("div", { class: "progress-tracker-container" }, index.h("mb-progress-tracker", { size: 3, current: this.activeStepIndex }))), this.activeStepIndex === 0 && (index.h("div", { class: "buttons onboarding" }, index.h("mb-button-classic", { clickHandler: () => {
        this.closeInternal();
      } }, this.texts.steps[this.activeStepIndex].buttonNext))), this.activeStepIndex === 1 && (index.h("div", { class: "buttons" }, index.h("mb-button-classic", { inverted: true, disabled: true, clickHandler: undefined }, this.texts.steps[this.activeStepIndex].buttonBack), index.h("mb-button-classic", { clickHandler: () => {
        this.activeStepIndex++;
      } }, this.texts.steps[this.activeStepIndex].buttonNext))), this.activeStepIndex === 2 && (index.h("div", { class: "buttons" }, index.h("mb-button-classic", { inverted: true, clickHandler: () => {
        this.activeStepIndex--;
      } }, this.texts.steps[this.activeStepIndex].buttonBack), index.h("mb-button-classic", { clickHandler: () => {
        this.activeStepIndex++;
      } }, this.texts.steps[this.activeStepIndex].buttonNext))), this.activeStepIndex === 3 && (index.h("div", { class: "buttons" }, index.h("mb-button-classic", { inverted: true, clickHandler: () => {
        this.activeStepIndex--;
      } }, this.texts.steps[this.activeStepIndex].buttonBack), index.h("mb-button-classic", { clickHandler: () => {
        this.closeInternal();
...
const MbProgressTracker = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "mb-progress-tracker" }, steps.map((step) => (index.h("div", { class: `dot ${currentCorrected === step ? "active" : "inactive"}` }))))));
  }
};
