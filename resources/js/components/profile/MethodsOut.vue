        ...
        <div v-if="!selectedMethod">
          <ul  class="methods-list__list mb-30">
            ...
            >
              ...
              <p class="methods-list__listitem--right">Rate: {{ method.rate?.toFixed(2) }}%</p>
              <p class="methods-list__listitem--right">Fee: {{ method.fix_fee?.toFixed(2)}} EUR</p>
            </ButtonWithClose>
          </ul>
        </div>
        ...
        <div v-else>
          <ul class="methods-list__list mb-30">
            <ButtonWithClose class="methods-list__listitem" is-active @click="selectMethod(selectedMethod)">
              ...
              <p class="methods-list__listitem--right">Rate: {{ selectedMethod.fix_fee?.toFixed(2) }}%</p>
              <p class="methods-list__listitem--right">Fix: {{ selectedMethod.fix_fee?.toFixed(2) }}EUR</p>
            </ButtonWithClose>
          </ul>
